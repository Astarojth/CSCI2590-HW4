...
- Extra-credit SQL filenames are reserved submission artifacts and should be generated through `autotune_scratch_supervisor.sh`.
 
For database records, ensure that the name of the submission files (in the `records/` subfolder) are:
- `t5_ft_experiment_test.pkl`
- Extra-credit record filenames are reserved submission artifacts and should be generated through `autotune_scratch_supervisor.sh`.
